     ...
     <table class="table">
        ...
        <tbody>
            ...
            echo '<tr>';
                ...
                <form action="./admininclude/editstudents.php" method="POST" class="d-inline">
...
<div>
    <a class="btn btn-danger box" href="./admininclude/addnewstudent.php"><i class="fas fa-plus fa-2x"></i></a>
</div>
</div>
...
if(isset($_REQUEST['delete'])){
    ...
    if($conn->query($sql) == TRUE){
        ...
        echo "Unabale to delete student";
    }
}
 ?>
